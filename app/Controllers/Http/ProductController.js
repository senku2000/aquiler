...
class ProductController {
    ...
    async adminIndex({ request, session, response, view }){
        ...
        const productsGet = (await Product.all()).toJSON()
        ...
        products.sort((product1, product2) => {
            ...
            if(orderBy==="name"){
                ...
                x = product1[orderBy].name.toLowerCase();
                y = product2[orderBy].name.toLowerCase();
                onDesc = 1
                if(x===y){
    ...
    async adminView({ params, request, view }){
